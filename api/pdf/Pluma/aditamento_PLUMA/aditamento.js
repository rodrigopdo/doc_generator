...
document.getElementById("longDateToday").innerHTML = `${longDate.getDate()} de ${formatedMonth} de ${longDate.getFullYear()}`;

//CURRENT DATE
let today = new Date().toLocaleDateString(); 
document.getElementById("dateToday").innerHTML = `${longDate.getDate()} de ${formatedMonth} de ${longDate.getFullYear()}`;
