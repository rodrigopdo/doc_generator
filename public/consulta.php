        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav navbar-nav ms-auto me-5 mb-2 mb-lg-0">
            <li class="nav-item me-4">
              <a class="nav-link" href="#">Consulta <i class="fas fa-search"></i></a>
            </li>
            <li class="nav-item me-4">
              <a class="nav-link" aria-current="page" href="#">Solicitação de Documentos</a>
            </li>
            ...
            <li class="nav-item me-4">
              <a class="nav-link" href="#">Boas-vindas</a>
            </li>
            <li class="nav-item">
